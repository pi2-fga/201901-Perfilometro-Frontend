...
class ExampleData {
    ...
    var sensor6Values:[Float] = [15.36, 14.74, 16.21, 18.28, 23.93, 29.32, 24.01, 42.48, 46.54, 75.22, 80.25, 108.81]
    var sensor7Values:[Float] = [0.0, 10.43951, 21.47, 32.19, 46.14, 13.6, 36.59, 11.8, 13.65, 9.32, 17.91, 63.16]
    var sensor8Values:[Float] = [53.3, 44.37, 22.19, 46.84, 39.79, 46.28, 17.12, 20.42, 68.44, 28.48, 29.94, 63.72]
    var sensor9Values:[Float] = [45.3, 48.37, 32.19, 56.84, 96.79, 74.28, 61.12, 70.42, 58.44, 42.48, 95.94, 83.72]
    var sensor10Values:[Float] = [58.3, 87.37, 29.19, 16.84, 49.79, 64.28, 71.12, 80.42, 98.44, 32.48, 49.94, 23.72]
