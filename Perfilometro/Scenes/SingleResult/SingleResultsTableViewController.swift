...
class SingleResultsTableViewController: UITableViewController, SCNSceneRendererDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.showRouteOnMap(pickupCoordinate: initialPoint, destinationCoordinate: finalPoint)
    }
...
extension SingleResultsTableViewController: MKMapViewDelegate {
    ...
    func showRouteOnMap(pickupCoordinate: CLLocationCoordinate2D, destinationCoordinate: CLLocationCoordinate2D) {
        ...
        self.routeInMap.showAnnotations([sourceAnnotation, destinationAnnotation], animated: true )
        ...
        directions.calculate {
            ...
            self.routeInMap.addOverlay((route.polyline), level: MKOverlayLevel.aboveRoads)
            
            let rect = route.polyline.boundingMapRect
            self.routeInMap.setRegion(MKCoordinateRegion(rect), animated: true)
        }
    }
